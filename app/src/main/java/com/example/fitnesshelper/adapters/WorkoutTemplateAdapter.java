...
public class WorkoutTemplateAdapter extends RecyclerView.Adapter<WorkoutTemplateAdapter.MyViewHolder>{
    ...
    public WorkoutTemplateAdapter(Context ct, ArrayList<WorkoutTemplate> templatesname , RecyclerViewInterface recyclerViewInterface /*,OnNoteListener onNoteListener*/){
        context = ct;
